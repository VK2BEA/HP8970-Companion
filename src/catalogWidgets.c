...
buildWidgetList( tGlobal *pGlobal,  GtkBuilder *builder ) {
    const static gchar *sWidgetNames[ eW_N_WIDGETS ] = {
            ...
            [ eW_chk_NoiseUnit_F ]              = "WID_chk_NoiseUnit_F",
            [ eW_chk_NoiseUnit_FdB ]            = "WID_chk_NoiseUnit_FdB",
            [ eW_chk_NoiseUnit_TeK ]            = "WID_chk_NoiseUnit_TeK",
            [ eW_chk_NoiseUnit_Y ]              = "WID_chk_NoiseUnit_Y",
            [ eW_chk_NoiseUnit_YdB ]            = "WID_chk_NoiseUnit_YdB",
            ...
            [ eW_combo_Smoothing ]              = "WID_combo_Smoothing",
